                                    ...
                                    <form action="{{ route('single-add-to-cart') }}" method="POST">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quant" class="input-number" data-min="1"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            <h4>{{ ceil($product_detail->getReview->avg('rate')) ?? 0 }}
                                                                <span>(Overall)</span></h4>
                                                            <span>Based on {{ $product_detail->getReview->count() ?? 0 }}
                                                                Comments</span>
                                                        </div>
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{ route('product-detail', $data->slug) }}">
                                                ...
                                                @if (!empty($data->photo))
                                                    <img class="default-img" src="{{ asset($data->photo) }}"
                                                        alt="{{ $data->title }}">
                                                    <img class="hover-img" src="{{ asset($data->photo) }}"
                                                        alt="{{ $data->title }}">
                                                @else
                                                    <img class="default-img" src="{{ asset('images/no-image.png') }}"
                                                        alt="No image">
                                                @endif
                                            ...
                                            <div class="button-head">
                                                ...
                                                <div class="product-action-2">
                                                    <a title="Add to cart"
                                                        href="{{ route('add-to-cart', $data->slug) }}">Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
