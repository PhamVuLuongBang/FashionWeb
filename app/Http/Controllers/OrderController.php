...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $shipping_price = isset($shipping[0]) ? $shipping[0] : 0;
        ...
        $total = Helper::totalCartPrice() + $shipping_price - ($order_data['coupon'] ?? 0);
        $order_data['total_amount'] = max($total, 0);
        ...
        $total_amount = number_format($order_data['total_amount'], 0, ',', '.');
        session()->flash('success', "You have successfully paid the amount {$total_amount}");
